...
NTAPI extern "C" KIRQL ExAcquireSpinLockExclusive(EX_SPIN_LOCK* lock);
NTAPI extern "C" KIRQL ExAcquireSpinLockShared(EX_SPIN_LOCK* lock);
NTAPI extern "C" void ExReleaseSpinLockExclusive(EX_SPIN_LOCK* lock, KIRQL old_irql);
NTAPI extern "C" void ExReleaseSpinLockShared(EX_SPIN_LOCK* lock, KIRQL old_irql);
NTAPI extern "C" u32 ExTryConvertSharedSpinLockExclusive(EX_SPIN_LOCK* lock);
