...
void KeInitializeSemaphore(KSEMAPHORE* semaphore, i32 count, i32 limit) {
...
i32 KeReleaseSemaphore(KSEMAPHORE* semaphore, KPRIORITY increment, i32 adjustment, bool wait) {
